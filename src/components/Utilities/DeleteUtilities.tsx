...
import { deleteUtilitiesByIdApi } from '@/api/utilities';
...
interface DeleteUtilitiesProps {
    open: boolean;
    setOpen: React.Dispatch<React.SetStateAction<boolean>>;
    utilitiesId: number | null;
}

const DeleteUtilities: React.FC<DeleteUtilitiesProps> = ({ open, setOpen, utilitiesId }) => {

    const mutation = useMutation({
        mutationFn: () => deleteUtilitiesByIdApi(utilitiesId as number),
        onSuccess: (data: any) => {
            if (data.status === 0) {
